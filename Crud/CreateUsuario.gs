...
const relacionAcudienteConBeneficiario = form.relacionAcudienteConBeneficiario;
...
const siDesnutricionCanalizadoAEntidadSalud = form.siDesnutricionCanalizadoAEntidadSalud;
